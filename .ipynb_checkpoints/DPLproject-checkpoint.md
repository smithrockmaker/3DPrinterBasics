...
Makerspaces are a new feature of the Deschutes Public Library (DPL) system. The first of these community spaces was completed at the Redmond Branch Library. The recently completed Central Branch of the DPL system also has a Makerspace. In all the makerpaces there are a number of resources that are available to patrons. Among those resources are 3D printers. This document is a tool to help guide patrons in accessing and using the 3D printers. Your feedback about this guide is always welcome as we work to improve your experience with the 3D printers in the makerspace. Feel free to share your insights with us with us [here](bemerson@cocc.edu).
